...
WHERE
    ...
    AND month = "7"
    AND year = "2020"
    AND street = "Chamberlin Street" -- Transcript from the interviews on the day of the crime
SELECT
    transcript
FROM
    interviews
...
SELECT
    activity
FROM
    courthouse_security_logs -- Get the name based on license plates of car exiting the courthouse 
SELECT
    name
FROM
    people
